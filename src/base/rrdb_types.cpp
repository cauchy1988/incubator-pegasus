...
int _knegotiate_feature_flagValues[] = {
  negotiate_feature_flag::BATCH_GET
};
const char* _knegotiate_feature_flagNames[] = {
  "BATCH_GET"
};
const std::map<int, const char*> _negotiate_feature_flag_VALUES_TO_NAMES(::apache::thrift::TEnumIterator(1, _knegotiate_feature_flagValues, _knegotiate_feature_flagNames), ::apache::thrift::TEnumIterator(-1, NULL, NULL));
...
void key_value::printTo(std::ostream& out) const {
  ...
  out << "key=" << to_string(key);
  out << ", " << "value=" << to_string(value);
  out << ", " << "expire_ts_seconds="; (__isset.expire_ts_seconds ? (out << to_string(expire_ts_seconds)) : (out << "<null>"));
  out << ")";
}
...
uint32_t get_scanner_request::write(::apache::thrift::protocol::TProtocol* oprot) const {
  ...
  if (this->__isset.validate_partition_hash) {
    xfer += oprot->writeFieldBegin("validate_partition_hash", ::apache::thrift::protocol::T_BOOL, 11);
...
void get_scanner_request::printTo(std::ostream& out) const {
  ...
  out << ", " << "sort_key_filter_type=" << to_string(sort_key_filter_type);
  out << ", " << "sort_key_filter_pattern=" << to_string(sort_key_filter_pattern);
  out << ", " << "validate_partition_hash="; (__isset.validate_partition_hash ? (out << to_string(validate_partition_hash)) : (out << "<null>"));
  out << ", " << "return_expire_ts="; (__isset.return_expire_ts ? (out << to_string(return_expire_ts)) : (out << "<null>"));
  out << ", " << "full_scan="; (__isset.full_scan ? (out << to_string(full_scan)) : (out << "<null>"));
  out << ")";
}
...
negotiate_feature_request::~negotiate_feature_request() throw() {
}


uint32_t negotiate_feature_request::read(::apache::thrift::protocol::TProtocol* iprot) {
...
uint32_t negotiate_feature_request::write(::apache::thrift::protocol::TProtocol* oprot) const {
  uint32_t xfer = 0;
  apache::thrift::protocol::TOutputRecursionTracker tracker(*oprot);
  xfer += oprot->writeStructBegin("negotiate_feature_request");
...
void swap(negotiate_feature_request &a, negotiate_feature_request &b) {
  using ::std::swap;
  (void) a;
  (void) b;
}

negotiate_feature_request::negotiate_feature_request(const negotiate_feature_request& other134) {
  (void) other134;
}
negotiate_feature_request::negotiate_feature_request( negotiate_feature_request&& other135) {
  (void) other135;
}
negotiate_feature_request& negotiate_feature_request::operator=(const negotiate_feature_request& other136) {
  (void) other136;
  return *this;
}
negotiate_feature_request& negotiate_feature_request::operator=(negotiate_feature_request&& other137) {
  (void) other137;
  return *this;
}
void negotiate_feature_request::printTo(std::ostream& out) const {
  using ::apache::thrift::to_string;
  out << "negotiate_feature_request(";
  out << ")";
}


negotiate_feature_response::~negotiate_feature_response() throw() {
}


void negotiate_feature_response::__set_supported_features(const std::vector<negotiate_feature_flag::type> & val) {
  this->supported_features = val;
}

uint32_t negotiate_feature_response::read(::apache::thrift::protocol::TProtocol* iprot) {
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      case 1:
        if (ftype == ::apache::thrift::protocol::T_LIST) {
          {
            this->supported_features.clear();
            uint32_t _size138;
            ::apache::thrift::protocol::TType _etype141;
            xfer += iprot->readListBegin(_etype141, _size138);
            this->supported_features.resize(_size138);
            uint32_t _i142;
            for (_i142 = 0; _i142 < _size138; ++_i142)
            {
              int32_t ecast143;
              xfer += iprot->readI32(ecast143);
              this->supported_features[_i142] = (negotiate_feature_flag::type)ecast143;
            }
            xfer += iprot->readListEnd();
          }
          this->__isset.supported_features = true;
        } else {
          xfer += iprot->skip(ftype);
        }
        break;
...
uint32_t negotiate_feature_response::write(::apache::thrift::protocol::TProtocol* oprot) const {
  uint32_t xfer = 0;
  apache::thrift::protocol::TOutputRecursionTracker tracker(*oprot);
  xfer += oprot->writeStructBegin("negotiate_feature_response");

  xfer += oprot->writeFieldBegin("supported_features", ::apache::thrift::protocol::T_LIST, 1);
  {
    xfer += oprot->writeListBegin(::apache::thrift::protocol::T_I32, static_cast<uint32_t>(this->supported_features.size()));
    std::vector<negotiate_feature_flag::type> ::const_iterator _iter144;
    for (_iter144 = this->supported_features.begin(); _iter144 != this->supported_features.end(); ++_iter144)
    {
      xfer += oprot->writeI32((int32_t)(*_iter144));
    }
    xfer += oprot->writeListEnd();
  }
  xfer += oprot->writeFieldEnd();
...
void swap(negotiate_feature_response &a, negotiate_feature_response &b) {
  using ::std::swap;
  swap(a.supported_features, b.supported_features);
  swap(a.__isset, b.__isset);
}

negotiate_feature_response::negotiate_feature_response(const negotiate_feature_response& other145) {
  supported_features = other145.supported_features;
  __isset = other145.__isset;
}
negotiate_feature_response::negotiate_feature_response( negotiate_feature_response&& other146) {
  supported_features = std::move(other146.supported_features);
  __isset = std::move(other146.__isset);
}
negotiate_feature_response& negotiate_feature_response::operator=(const negotiate_feature_response& other147) {
  supported_features = other147.supported_features;
  __isset = other147.__isset;
  return *this;
}
negotiate_feature_response& negotiate_feature_response::operator=(negotiate_feature_response&& other148) {
  supported_features = std::move(other148.supported_features);
  __isset = std::move(other148.__isset);
  return *this;
}
void negotiate_feature_response::printTo(std::ostream& out) const {
  using ::apache::thrift::to_string;
  out << "negotiate_feature_response(";
  out << "supported_features=" << to_string(supported_features);
  out << ")";
}
