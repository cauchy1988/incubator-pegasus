...
GTEST_OUTPUT="xml:$REPORT_DIR/features_negotiation.xml" GTEST_FILTER="features_negotiation_test.*" ./$test_case $config_file $table_name
exit_if_fail $? "run test features negotiation failed: $test_case $config_file $table_name"
