...
struct negotiate_feature_flag {
  enum type {
    BATCH_GET = 0
  };
};

extern const std::map<int, const char*> _negotiate_feature_flag_VALUES_TO_NAMES;
...
class negotiate_feature_request;

class negotiate_feature_response;
...
typedef struct _get_scanner_request__isset {
  _get_scanner_request__isset() : start_key(false), stop_key(false), start_inclusive(false), stop_inclusive(false), batch_size(false), no_value(false), hash_key_filter_type(false), hash_key_filter_pattern(false), sort_key_filter_type(false), sort_key_filter_pattern(false), validate_partition_hash(false), return_expire_ts(false), full_scan(false) {}
  bool start_key :1;
  bool stop_key :1;
  bool start_inclusive :1;
  bool stop_inclusive :1;
...
class get_scanner_request {
 public:
  ...
  get_scanner_request() : start_inclusive(0), stop_inclusive(0), batch_size(0), no_value(0), hash_key_filter_type((filter_type::type)0), sort_key_filter_type((filter_type::type)0), validate_partition_hash(0), return_expire_ts(0), full_scan(0) {
  }
  ...
  bool operator == (const get_scanner_request & rhs) const
  {
    ...
    if (__isset.validate_partition_hash != rhs.__isset.validate_partition_hash)
      return false;
    else if (__isset.validate_partition_hash && !(validate_partition_hash == rhs.validate_partition_hash))
      return false;
...
class negotiate_feature_request {
 public:
  ...
  negotiate_feature_request(const negotiate_feature_request&);
  negotiate_feature_request(negotiate_feature_request&&);
  negotiate_feature_request& operator=(const negotiate_feature_request&);
  negotiate_feature_request& operator=(negotiate_feature_request&&);
  negotiate_feature_request() {
  }

  virtual ~negotiate_feature_request() throw();

  bool operator == (const negotiate_feature_request & /* rhs */) const
  {
    return true;
  }
  bool operator != (const negotiate_feature_request &rhs) const {
  ...
  bool operator < (const negotiate_feature_request & ) const;
...
inline std::ostream& operator<<(std::ostream& out, const negotiate_feature_request& obj)
{
  obj.printTo(out);
  return out;
}

typedef struct _negotiate_feature_response__isset {
  _negotiate_feature_response__isset() : supported_features(false) {}
  bool supported_features :1;
} _negotiate_feature_response__isset;

class negotiate_feature_response {
 public:

  negotiate_feature_response(const negotiate_feature_response&);
  negotiate_feature_response(negotiate_feature_response&&);
  negotiate_feature_response& operator=(const negotiate_feature_response&);
  negotiate_feature_response& operator=(negotiate_feature_response&&);
  negotiate_feature_response() {
  }

  virtual ~negotiate_feature_response() throw();
  std::vector<negotiate_feature_flag::type>  supported_features;

  _negotiate_feature_response__isset __isset;

  void __set_supported_features(const std::vector<negotiate_feature_flag::type> & val);

  bool operator == (const negotiate_feature_response & rhs) const
  {
    if (!(supported_features == rhs.supported_features))
      return false;
    return true;
  }
  bool operator != (const negotiate_feature_response &rhs) const {
  ...
  bool operator < (const negotiate_feature_response & ) const;
...
inline std::ostream& operator<<(std::ostream& out, const negotiate_feature_response& obj)
{
  obj.printTo(out);
  return out;
}
